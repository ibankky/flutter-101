  ...
  Future<Null> initDatabase() async {
    await openDatabase(
      ...
      onCreate: (db, version) => db.execute(
          'CREATE TABLE $nameTable (id INTEGER PRIMARY KEY, $columnIdUser TEXT, $columnNameUser TEXT, $columnIdProduct, TEXT, $columnPrice TEXT, $columnAmount TEXT, $columnSum TEXT, $columnNameProduct TEXT)'),
      version: version,
    );
  }
